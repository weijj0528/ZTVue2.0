...
var CompressionWebpackPlugin = require('compression-webpack-plugin') // 压缩
var fs = require('fs');

config.output.path = path.join(__dirname, './dist-prod/static')
config.output.publicPath = './static';             // 资源路径,根据需要可改为cdn地址
